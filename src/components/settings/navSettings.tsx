...
import style from "../../styles/components/settings/navSettings.module.css";
    ...
    return(
        <div className={style.titleBar} data-tauri-drag-region onContextMenu={ clickHandler }>
            ...
            <div className={style.titleBarButtons} data-tauri-drag-region>
                {!isHypr ?
                    <>
                    <button data-tauri-drag-region="false" onClick={handleMinimize}>
                    ...
                    <button data-tauri-drag-region="false" onClick={handleMaximize}>            
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button data-tauri-drag-region="false" onClick={handleClose}>            
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
